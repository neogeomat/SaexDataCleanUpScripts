    ...
    def fixGapsAndOverlaps (self):
        ...
        for i in mdb_list:
            ...
            if (no_of_attribute == 0):
                ...
                arcpy.FeatureClassToFeatureClass_conversion(Data_Location+"\\Cadastre\\Parcel", DataCleanTemp,"\\Parcel.shp","",
                                                            "Region \"अञ्चल\" true true false 255 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,Region,-1,-1;DistrictCode \"जिल्ला_कोड\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,DistrictCode,-1,-1;District \"जिल्ला\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,District,-1,-1;VDCCode \"गाविस_कोड\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,VDCCode,-1,-1;VDC \"गाविस\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,VDC,-1,-1;Ward \"वार्ड\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,Ward,-1,-1;MapSheetNumber \"नक्सा_सिट_नम्बर\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,MapSheetNumber,-1,-1;ParcelNo \"जमिनको_कित्ता_नम्बर\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelNo,-1,-1;ParcelNoEng \"ParcelNoEng\" true true false 4 Long 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelNoEng,-1,-1;ParcelKey \"कित्ता_संकेत_नम्बर\" true true false 255 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelKey,-1,-1;OwnerId \"जग्गाधनी_संकेत_नम्बर\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,OwnerId,-1,-1;Tenant_id \"मोहीको_संकेत_नम्बर\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,Tenant_id,-1,-1;ParcelClass \"किसिम\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelClass,-1,-1;ParcelType \"विरह\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelType,-1,-1;ParcelRegionClass \"जग्गाको_क्षेत्रीय_किसिम\" true true false 100 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,ParcelRegionClass,-1,-1;ParcelClassValue \"किसिम_मान\" true true false 100 Text 0 0 ,First,#,"
                                                                              ...
                                                                              + Data_Location + "\\Cadastre\\Parcel,SurveyTeamNo,-1,-1;SurveyOfficeName \"नापी_कार्यालय\" true true false 100 Text 0 0 ,First,#,"
                                                                              ...
                                                                              + Data_Location + "\\Cadastre\\Parcel,SqFeet,-1,-1;Bigha \"बिघा\" true true false 50 Text 0 0 ,First,#,"
                                                                              + Data_Location + "\\Cadastre\\Parcel,Bigha,-1,-1;Ropani \"रोपनी\" true true false 50 Text 0 0 ,First,#,"
                ...
                arcpy.CopyFeatures_management(BLANK84_Template + "\\Cadastre\\Parcel",parcel_location, "", "0", "0", "0")

                # Process: Feature Class To Coverage
                cov1 = DataCleanTemp + "\\cov1"
                arcpy.FeatureclassToCoverage_conversion(DataCleanTemp + "\\Parcel.shp REGION", cov1,"0.005 Meters","DOUBLE")
...
root = Tk()
root.title("Clean PE Mdb files " + version)
myapp = App(root)
myapp.mainloop()
