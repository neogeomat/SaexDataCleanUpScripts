            ...
            try:
                ...
                if(no_of_attribute==0):
                    ...
                    arcpy.FeatureClassToFeatureClass_conversion(Data_Location + "\\Parcel", DataCleanTemp, "Parcel.shp", "",
                                                                ...
                                                                + Data_Location + "\\Parcel,Shape_Area,-1,-1;id \"id\" true false false 250 Text 0 0 ,First,#,"
                                                                + Data_Location + "\\Parcel,id,-1,-1", "")
                    ...
                    arcpy.SpatialJoin_analysis(DataCleanTemp + "\\CleanPoly.shp", DataCleanTemp + "\\ParcelCentroid.shp",
                                               ...
                                               + DataCleanTemp + "\\ParcelCentroid.shp,ORIG_FID,-1,-1;id \"id\" true false false 250 Text 0 0 ,First,#,"
                                               + DataCleanTemp + "\\ParcelCentroid.shp,id,-1,-1;", "CONTAINS", "", "")
                    ...
                    arcpy.SpatialJoin_analysis(DataCleanTemp + "\\SegmentsParcelIntersect.shp", Data_Location + "\\Parcel",
                                               ...
                                               + Data_Location + "\\Parcel,Ids,-1,-1;id \"id\" true false false 250 Text 0 0 ,First,#,"
                                               + Data_Location + "\\Parcel,id,-1,-1", "INTERSECT", "", "")
